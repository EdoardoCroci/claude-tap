#!/bin/bash
# Claude Tap - Uninstaller
#
# Removes:
#   - Claude Code hooks (Notification, Stop) pointing to this tool
#   - Status line configuration
#   - ~/.config/claude-tap/ directory (binary, assets, config)
...
echo ""
echo -e "${BOLD}Claude Tap - Uninstaller${RESET}"
echo ""
...
# Remove status line if it points to our script
...
echo -e "You can safely delete the ${CYAN}$(basename "$SCRIPT_DIR")/${RESET} folder if you no longer need it."
echo ""
